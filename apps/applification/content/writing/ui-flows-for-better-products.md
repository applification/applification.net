---
title: Creating UI Flows leads to a better product
date: '2015-01-06'
updated: '2022-02-13'
type: post
summary: How to use UI flows
topics:
  - design
featured: false
draft: false
slug: ui-flows-for-better-products
legacyId: '8'
---
...
Enter UI flows — a shorthand for designing the flow of a user interface, imagined by [Ryan Singer](https://signalvnoise.com/posts/1926-a-shorthand-for-designing-ui-flows).

The basic composition of a UI flow is as follows:

![UI flow template: what the user sees above a line and what they do below, leading to what they see and do next](/images/writing/ui-flows-for-better-products-01-14a15e2e8f.png)

Flow Template

You can hand draw UI Flows and often I start that way but generally I prefer to create a digital version which can be collaborated on and shared easily. The tool I use to do this is [Lucid Chart](http://lucidchart.com/), one of my go-to tools for a range of tasks!
...
![UI flow for a QR code book app, from splash screen to menu options and the QR code scanner](/images/writing/ui-flows-for-better-products-02-84fe10bfcf.png)
