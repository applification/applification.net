...
metadata:
  ...
  applification-mcp-url: ${siteUrl}/api/mcp
  applification-docs-url: ${siteUrl}/developers
---
...
MCP hosts can connect to \`${siteUrl}/api/mcp\` (Streamable HTTP, no authentication) for the same three operations as tools: search_site, read_content and get_applification_info. Developer documentation, SDKs and the CLI are described at ${siteUrl}/developers.
