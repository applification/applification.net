...
export function DetailContextRail({
  ...
  return (
    <div
      className={`font-caption flex min-h-11 w-full flex-wrap items-center justify-between gap-x-6 gap-y-2 text-[10px] font-bold tracking-[0.8px] uppercase min-[1024px]:text-xs min-[1024px]:font-semibold ${className}`}
    >
