...
import { careerTimeline, positions, profileFacts, bestFit, selectedWriting } from "@/lib/content/about";
export { careerTimeline } from "@/lib/content/about";
