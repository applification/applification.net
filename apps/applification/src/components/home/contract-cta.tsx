  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-[18px] min-[1024px]:flex-row min-[1024px]:items-center min-[1024px]:justify-between min-[1024px]:gap-[60px]">
        ...
        <a
          className={`${dark ? "bg-white text-[#111827] hover:bg-[#e2e8f0] active:bg-[#cbd5e1] min-[1024px]:min-h-[51px] min-[1024px]:gap-2.5 min-[1024px]:px-6" : "bg-[var(--cta-action)] text-[var(--cta-action-text)] hover:bg-[var(--cta-action-hover)] active:bg-[var(--cta-action-active)]"} inline-flex min-h-[50px] w-full shrink-0 items-center justify-center gap-2 rounded-full px-[22px] text-[15px] font-bold transition-[background-color,transform] active:translate-y-px focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--cta-focus)] motion-reduce:transform-none motion-reduce:transition-none min-[1024px]:w-auto min-[1024px]:font-semibold`}
