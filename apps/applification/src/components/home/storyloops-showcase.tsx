  ...
  return (
    <div className={`${detail ? "" : "rounded-[20px]"} overflow-hidden bg-[var(--storyloop-shell)] min-[1024px]:hidden`}>
      ...
      <div className="flex flex-col gap-3.5 px-4 pt-5 pb-[18px]">
        ...
        <div className="rounded-xl bg-[var(--storyloop-proposal)] p-3.5">
          ...
          <div className="mt-2.5 grid grid-cols-2 gap-2">
            <span className="flex h-11 items-center justify-center rounded-full bg-[var(--app-action)] text-[13px] font-bold text-[var(--app-text-on-action)]">Review</span>
            <span className="flex h-11 items-center justify-center rounded-full bg-[var(--storyloop-panel-card)] text-[13px] font-bold text-[var(--storyloop-text-secondary)]">Reject</span>
          </div>
        </div>
      </div>
    </div>
