  ...
  return (
    <figure className="grid min-w-0 gap-7 overflow-hidden rounded-[22px] bg-[var(--app-muted-section)] p-5 ring-1 ring-inset ring-[var(--app-border)] sm:grid-cols-[minmax(190px,240px)_272px] sm:items-center sm:justify-center sm:justify-items-center min-[1024px]:h-[500px] min-[1024px]:px-[30px] min-[1024px]:py-6">
      <figcaption className="sr-only">
        Plantry combines food that needs using, available cooking effort and household preferences to propose tonight&apos;s plan.
      </figcaption>
...
function PlantryHero() {
  return (
    <section
      ...
      className="bg-[var(--app-bg)] px-6 py-12 min-[1024px]:min-h-[610px] min-[1024px]:px-20 min-[1024px]:py-[55px]"
    >
      <div className="mx-auto grid w-full max-w-[1280px] gap-10 min-[1360px]:grid-cols-[580px_minmax(0,1fr)] min-[1360px]:items-center min-[1360px]:gap-16">
        <div className="flex flex-col items-start gap-5">
          <ProductDetailEyebrow>PRODUCTS&nbsp; / &nbsp;PLANTRY</ProductDetailEyebrow>
          <h1
